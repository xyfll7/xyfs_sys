...
import { try_Taro_scanCode, try_Taro_showModal } from '@xyfs/taro_uii/utils/try_catch';
      ...
      <View className='ww prl10'>
        ...
        <View className='dll ww'>
          ...
          <ComButton className='bccback mb10'>
            <Text className='mr6'> 打印猿：ID</Text>
  ...
  return <>
    ...
    {selfInfo_S.printers?.map((printer) => (
      <View className='prl10 pt10 ioo bccwhite mb10 dll ww' key={printer.siid}>
        <ComButton ll className='mb10 cccplh'>打印机ID {printer.siid}</ComButton>
        <View className='dbtc mb10 ww'>
          <ComButton ll className='cccplh'> 打印方向 {printer.direction === 1 ? "正向" : "反向"}</ComButton>
