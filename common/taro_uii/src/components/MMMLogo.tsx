...
export const MMMLogo: FC<ViewProps & { rr?: boolean, ll?: boolean; skewX?: string; }> = ({ className, rr, ll, skewX = "7deg", }) => {
  return <View className={`ds ${className}`}>
    <ComButton rr={rr} ll={ll} className='bccyellow  dy pr  IOO' hoverClass="none" style={{ minHeight: "2rem !important", transform: `skewX(-${skewX})`, marginRight: "calc(2 * var(--rem_base)) !important" }} >
