...
export const MMMLogo: FC<ViewProps & { rr?: boolean, ll?: boolean; skewX?: string; }> = ({ className, rr, ll, skewX = "17deg", }) => {
  return <View className={`ds ${className}`}>
    <ComButton rr={rr} ll={ll} className='bccyellow  dy pr  IOO' style={{ transform: `skewX(-${skewX})`, marginRight: "calc(2 * var(--rem_base)) !important" }} >
